...
- name: page_view
  code: "const mockData = {\n    \"addRevenue\":false,\n    \"addItemUrl\":false,\n\
    ...
    \ });\n\nrunCode(mockData);\n\nassertApi(\"createQueue\").wasCalledWith('__tfa_pixel_init');\n\
    assertApi(\"createQueue\").wasCalledWith('_tfa');\nassertApi(\"copyFromWindow\"\
    ).wasCalledWith('__tfa_pixel_init');\n\nassertApi('injectScript').wasCalled();\
    \ \nassertApi('gtmOnSuccess').wasCalled();"
- name: make_purchase
  code: "// Mock _tfa queue\nconst _tfaMessages = [];\nmock(\"createQueue\", () =>\
    \ {\n\tconst push = (item) => {\n\t\t_tfaMessages.push(item);\n\t};\n\treturn\
    \ push;\n});\n\n// Pretend that page_view was already sent\nmock(\"copyFromWindow\"\
    , (key) => {\n  if (key === \"__tfa_pixel_init\") return \"123456789\";\n});\n\
    \nconst mockData = {\n    \"accountId\": \"123456789\",\n    \"pixelType\": \"\
    event\",\n    \"eventName\": \"make_purchase\",\n    \"addRevenue\": false,\n\
    \    \"revenue\": 123.45,\n    \"addCurrency\": true,\n    \"currency\": \"EUR\"\
    ,\n};\nmock('injectScript', (url, onSuccess, onFailure) => { onSuccess(); });\n\
    \nrunCode(mockData);\n\n// Validate that a certain message was pushed\nassertThat(_tfaMessages).contains({\n\
    \    \"notify\": \"event\",\n    \"id\": \"123456789\",\n    \"revenue\": 123.45,\n\
    \    \"currency\": \"EUR\",\n    \"name\": \"make_purchase\"\n});\n\nassertApi(\"\
    createQueue\").wasCalledWith('__tfa_pixel_init');\nassertApi(\"createQueue\").wasCalledWith('_tfa');\n\
    assertApi(\"copyFromWindow\").wasCalledWith('__tfa_pixel_init');\n\nassertApi('injectScript').wasCalled();\
    \ \nassertApi('gtmOnSuccess').wasCalled();"


___NOTES___

Created on 26.3.2024, 18:02:01
